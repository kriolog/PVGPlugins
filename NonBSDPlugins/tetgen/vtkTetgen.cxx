...
//																																																		//
	 ...
	 connect->SetInputData(realInput);
...
//---------------------------------------------------------------------------------------//
	...
	{
		regionNumbers = vtkDataArray::SafeDownCast(this->GetInputArrayToProcess(0, input));	// reading the input map3d attributs if they exist
